...
const GoalWeightSelectionPage: React.FC = () => {
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      <Text style={styles.title}>Step 3 of 6</Text>
      <Text style={styles.subtitle}>WHAT'S YOUR GOAL WEIGHT?</Text>
      ...
      {/* Next Steps Button */}
      <Link href="/height-selection" asChild>
...
export default GoalWeightSelectionPage;